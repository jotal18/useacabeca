...
$dbc = mysqli_connect('localhost', 'root', '', 'aliendatabase') or die('Erro ao conectar-se ao banco de dados.');

// ----- ou -------------
//$dbc = mysqli_connect('localhost', 'root', '');
//myqli_select_db($dbc, 'aliendatabase');

or die('Erro ao conectar-se ao banco de dados.');


//Cria a query (consulta ao banco de dados)
...
//Executa a query
$result = mysqli_query($dbc, $query) or die('Erro ao realizar a consulta no banco de dados.');
